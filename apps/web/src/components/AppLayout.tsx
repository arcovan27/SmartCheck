...
function executiveNavigation(): NavigationGroup[] {
  return [
    { id: "overview", title: "Visão Geral", items: [{ to: "/gestao-arcovan", label: "Dashboard executivo", permission: "GESTAO_ARCOVAN_VIEW", exact: true }] },
    { id: "overview", title: "Gestão Arcovan", items: [{ to: "/gestao-arcovan/historico-checklist", label: "Histórico de checklists", permission: "GESTAO_ARCOVAN_VIEW" }, { to: "/gestao-arcovan/downloads", label: "Downloads", permission: "DOWNLOAD_MANAGE" }] },
    ...
    { id: "maintenance", title: "Manutenção e Engenharia", items: maintenanceMenu },
    ...
    { id: "admin", title: "Administração e Cadastros", items: cadastroMenu.map((item) => ({ ...item, permission: "permission" in item ? item.permission : "GESTAO_ARCOVAN_VIEW" })) }
  ];
}
